...
export default class command extends BaseCommand {
    override execute = async (M: Message): Promise<void> => {
        ...
        if (amount > 50000) return void M.reply(`💀 *Kid You can't bet more than 50000 golds*`)
        if (amount < 100) return void M.reply(`🤣 *Lmao kid You can't bet  less than 100 golds.*`)
